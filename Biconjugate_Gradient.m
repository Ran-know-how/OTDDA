%=========================================================================%           
% Iterative Method, Biconjugate gradient %迭代法，双共轭梯度
% Applying Biconjugate gradient to obtainPx,Py,PZ %应用双共轭梯度获得Px、Py、PZ
%=========================================================================%
...
%=================== Applying complex conjugate gradient =================%应用复共轭梯度
while Error>CT  % CT is convergence threshold 收敛阈值
% while 1
    %=== Performing inverse FFT to obtain matrix-vector multiplication ===%执行逆FFT以获得矩阵向量乘法
    %=====================================================================%
