...
[F_line,T_line] = force_line(r_eff,gird,Lambda,Np_shape,Structure,IB,E01,H01,K01,CT,GPU,np,nb,direction,l_scan,z0,p,l,Waist_r);
...
df_diff = diff(F_line) ./ diff(l_scan');
% df_grad = gradient(F_line, z);
%% Generate the plots
% 计算中点位置
l_scan_mid = (l_scan(1:end-1) + l_scan(2:end)) / 2;
